...
Beech-Linux-Debug:
	 $(PROJECTBUILD) Beech Linux Debug  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

Beech-Linux-DebugGame:
	 $(PROJECTBUILD) Beech Linux DebugGame  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

Beech-Linux-Shipping:
	 $(PROJECTBUILD) Beech Linux Shipping  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

Beech-Linux-Test:
	 $(PROJECTBUILD) Beech Linux Test  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

Beech:
	 $(PROJECTBUILD) Beech Linux Development  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

BeechEditor-Linux-Debug:
	 $(PROJECTBUILD) BeechEditor Linux Debug  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

BeechEditor-Linux-DebugGame:
	 $(PROJECTBUILD) BeechEditor Linux DebugGame  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

BeechEditor-Linux-Shipping:
	 $(PROJECTBUILD) BeechEditor Linux Shipping  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

BeechEditor-Linux-Test:
	 $(PROJECTBUILD) BeechEditor Linux Test  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

BeechEditor:
	 $(PROJECTBUILD) BeechEditor Linux Development  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)
