...
unrealRootPath=/home/keeganmccallum/Dev/Hacking/UnrealEngine
BeechRootPath=/home/keeganmccallum/Documents/Unreal Projects/Beech

gameProjectFile=/home/keeganmccallum/Documents/Unreal Projects/Beech/Beech.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(BeechSource.pri)
include(BeechHeader.pri)
include(BeechConfig.pri)
include(BeechIncludes.pri)
include(BeechDefines.pri)
...
Beech-Linux-Debug.commands = $$build Beech Linux Debug  -project="\"$$gameProjectFile\"" $$args
Beech-Linux-DebugGame.commands = $$build Beech Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
Beech-Linux-Shipping.commands = $$build Beech Linux Shipping  -project="\"$$gameProjectFile\"" $$args
Beech-Linux-Test.commands = $$build Beech Linux Test  -project="\"$$gameProjectFile\"" $$args
Beech.commands = $$build Beech Linux Development  -project="\"$$gameProjectFile\"" $$args

BeechEditor-Linux-Debug.commands = $$build BeechEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
BeechEditor-Linux-DebugGame.commands = $$build BeechEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
BeechEditor-Linux-Shipping.commands = $$build BeechEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
BeechEditor-Linux-Test.commands = $$build BeechEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
BeechEditor.commands = $$build BeechEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	Beech-Linux-Debug \
	Beech-Linux-DebugGame \
	Beech-Linux-Shipping \
	Beech-Linux-Test \
	Beech \
	BeechEditor-Linux-Debug \
	BeechEditor-Linux-DebugGame \
	BeechEditor-Linux-Shipping \
	BeechEditor-Linux-Test \
	BeechEditor \
